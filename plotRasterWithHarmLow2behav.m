function plotRasterWithHarmLow2behav(sua, audio, timeWin, sampleRate, saveFig, figName, padding, segment, neuralDelay, behav, behavOverlay)
...
[power, T] = mySpecFull(audio, timeWinPadded, sampleRate, 0, []);
imagesc(T, 0:5:9e3, power);
xlim(timeWinPadded)
...
%yticks(0:500:13000);
ylim([300, 9e3])
yticks([300, 1000:1000:9e3])
yticklabels([300, 1000:1000:9e3]/1000)
ylabel('Freq. (kHz)')
colormap('turbo')
set(gca, 'TickDir', 'out');
box off
